    ...
    <main class="main-content">
      <header class="main-header">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 style="font-size:15px;font-weight:700">{{ pageTitle }}</h1>
...
const userInitial = computed(() => (auth.user?.nama || 'S').charAt(0).toUpperCase())
const currentDate = computed(() => new Date().toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' }))
const pageTitle = computed(() => ({ 'siswa.dashboard': 'Dashboard', 'siswa.absensi': 'Absensi Saya', 'siswa.profil': 'Profil Saya' }[route.name] || 'ASPIRA'))
...
const navItems = [
  { to: '/siswa/dashboard', label: 'Dashboard', icon: I('M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6'), name: 'dashboard' },
  { to: '/siswa/absensi', label: 'Absensi Saya', icon: I('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'), name: 'absensi' },
  { to: '/siswa/profil', label: 'Profil Saya', icon: I('M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'), name: 'profil' },
]
</script>
